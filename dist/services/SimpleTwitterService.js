...
exports.SimpleTwitterService = void 0;
...
class SimpleTwitterService {
     ...
     */
    async postTweet(message, imagePath) {
        ...
        try {
            ...
            const tweetOptions = { text: message };
     ...
     * @returns Promise that resolves to a boolean indicating success
     */
    async postEarthquakeReport(message, imagePath) {
     ...
     * @returns Promise that resolves to a boolean indicating success
     */
    async postPredictionTweet(message) {
...
exports.SimpleTwitterService = SimpleTwitterService;
