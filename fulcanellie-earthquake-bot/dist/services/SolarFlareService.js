...
exports.SolarFlareService = void 0;
...
class SolarFlareService {
    constructor() {
        this.NOAA_DONKI_API = 'https://api.nasa.gov/DONKI/FLR';
    ...
    async getRecentXClassFlares() {
        try {
            ...
            const xClassFlares = response.data
                .filter((flare) => flare.classType && flare.classType.startsWith('X'))
                .map((flare) => ({
     ...
     */
    getMysticalInterpretation(intensity) {
        if (intensity >= 10) {
...
exports.SolarFlareService = SolarFlareService;
