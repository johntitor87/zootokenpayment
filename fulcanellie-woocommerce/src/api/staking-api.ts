...
// Config type (matches staking-config.json)
...
// Load config: from env (e.g. Render) or from staking-config.json
function loadConfig(): StakingConfig {
  // Prefer env vars for deployment (Render, etc.)
